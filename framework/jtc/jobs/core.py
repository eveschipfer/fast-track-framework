...
def set_container(container: Container) -> None:
    ...
    Example:
        >>> from jtc.core import Container
        >>> from jtc.jobs import set_container
        >>> container = Container()
...
class Job(ABC):
    ...
    async def dispatch(cls, **kwargs: Any) -> None:
        ...
        await queue.enqueue(
            "jtc.jobs.core.runner",  # The universal runner function
...
async def runner(ctx: dict[str, Any], *, job_class: str, payload: dict[str, Any]) -> None:
    ...
    Args:
        ...
        job_class: Fully qualified class name (e.g., "jtc.jobs.SendWelcomeEmail")
    ...
    Example (SAQ Worker perspective):
        ...
        ...     job_class="jtc.jobs.SendWelcomeEmail",
        ...     payload={"user_id": 123}
        ... )
    """
    ...
    # Example: "jtc.jobs.SendWelcomeEmail" -> module="jtc.jobs", class="SendWelcomeEmail"
