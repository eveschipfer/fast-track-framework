...
class {class_name}(Seeder):
    ...
    async def run(self) -> None:
        ...
        This method is called when you execute `jtc db:seed`.
...
from jtc.events import Event as {event_name}  # Replace with actual import
...
def get_auth_controller_template() -> str:
    ...
    return '''"""
Authentication Controller (Generated by jtc make:auth)
...
def get_login_request_template() -> str:
    ...
    return '''"""
Login Request (Generated by jtc make:auth)
...
def get_register_request_template() -> str:
    ...
    return '''"""
Register Request (Generated by jtc make:auth)
...
def get_user_model_template() -> str:
    ...
    return '''"""
User Model (Generated by jtc make:auth)
...
def get_user_repository_template() -> str:
    ...
    return '''"""
User Repository (Generated by jtc make:auth)
...
def get_middleware_template(name: str) -> str:
    ...
    return f'''"""
{name} Middleware (Generated by jtc make:middleware)
...
Usage:
    ...
    from jtc.http.middleware.{snake_name} import {name}
...
def get_command_template(name: str) -> str:
    ...
    return f'''"""
{name} Command (Generated by jtc make:command)
...
Educational Note:
    ...
    you need to manually register this command in src/jtc/cli/main.py.

Registration:
    Add this to src/jtc/cli/main.py:

    from jtc.cli.commands.{snake_name} import app as {snake_name}_app
...
from jtc.models.{model_name.lower()} import {model_name}
 ...
 * {name} Load Test
 *
 * k6 load testing script for {name.replace("_", " ").title()}.
 * Generated by Fast Track Framework CLI.
 *
 * Usage:
 *   k6 run workbench/tests/load/{name}.js
 *
 *   Or with custom VUs and duration:
 *   k6 run --vus 50 --duration 1m workbench/tests/load/{name}.js
 *
...
export const options = {{
    ...
    stages: [
        // Ramp up to {vus} VUs over 10 seconds
        {{ duration: "10s", target: {vus} }},
        // Stay at {vus} VUs for {duration}
...
#     id: int,
#     repo: MyRepository = Inject(MyRepository)
# ):
#     item = await repo.find_or_fail(id)
#     return item
