...
def main(
    ...
    """
    TestDeploy command - Add description here.
    ...
    Example:
        $ jtc testdeploy --option value
        $ jtc testdeploy --flag
    """
    console.print(f"[bold cyan]Running TestDeploy command...[/bold cyan]")
