...
class Translator:
    ...
    def _get_framework_translation_path(self, locale: str) -> Path:
        ...
        Example:
            ...
            PosixPath('src/ftf/resources/lang/en.json')
        """
        # Framework translations are in src/ftf/resources/lang/
