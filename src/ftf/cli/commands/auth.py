...
from ftf.cli.commands.make import create_file
...
def make_auth(
    ...
    auth_controller_path = Path("src/ftf/http/controllers/auth_controller.py")
    ...
    console.print("[dim]   from ftf.http.controllers.auth_controller import router")
